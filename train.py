'''
  ...
  utoTask         : Stacked AutoEncoder Implementation
...
channel    = 3
n_outputs  = 10
model_name = "models/stacked_ae/digists"
...
# Step 1: Create Model
model = stacked_ae.Stacked_AE((None,height, width, channel), latent = 200, units=2)
